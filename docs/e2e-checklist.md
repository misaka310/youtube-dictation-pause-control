...
**前提条件**
- YouTube動画が再生中。
- Typelessのホットキーが`Ctrl + Shift`。
- Wispr Flowは停止中。

**操作手順**
1. `Ctrl + Shift`を押して離し、Typelessを開始する。
2. 動画停止を確認する。
3. 400ms以上待ち、同じ操作で終了する。
...
**失敗時の切り分け**
- `Ctrl + Shift`が他アプリ操作としてしか反応しない場合、AHKの`Registered Typeless modifier hook`を確認。
